...
<body>
    ...
    <header id="header" class="fixed-top">
        <div class="container d-flex align-items-center">
            ...
            <a href="inventory.php" class="get-started-btn">Get Started</a>
        ...
        <div class="container center">
            ...
            <form>
                ...
                <div class="row aa">
                    ...
                    <div class="row">
                    <div class="col-md-6 form-group mt-2">
                        <label class="form-control-label">ชื่อครุภัณฑ์</label><input type="text"
                            class="form-control" name="initemid" placeholder="ชื่อครุภัณฑ์" value="" required>
                    </div>
                    </div>
        ...
        <div class="table-responsive">
            <table class="table container  mt-3 table-bordered table-striped">
                ...
                -->
                            ...
                            <td align="center">
                                <div class="btn-group">
                                    <a href="editinventory.php?itemid=<?php echo $inventory['Item_id']; ?>"
